...
export const WarehouseBox = ({ warehouse }: Props) => {
  ...
  return (
    ...
    >
      ...
      <Text mt={2}>
        <Icon as={BiCode} mr={1} />
        <b>{t("Code")}:</b> {warehouse.code}
      </Text>
      <Text mt={2}>
        <Icon as={IoLogoCapacitor} mr={1} />
        <b>{t("Capacity")}:</b> {warehouse.Free_capacity}
      </Text>
      <Text mt={2}>
        <Icon as={FaUser} mr={1} /> <b>{t("Keeper")}:</b> {warehouse.keeper}
      </Text>
      <Text mt={2}>
        <Icon as={FaWarehouse} mr={1} /> <b>{t("main_warehouse")}:</b>{" "}
        {warehouse.main_Warehouse?.name}
      </Text>
      <Text mt={2}>
        <Icon as={FaCity} mr={1} /> <b>{t("Branch")}:</b> {warehouse.branch?.name}
      </Text>
